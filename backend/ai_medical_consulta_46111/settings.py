"""
Django settings for ai_medical_consulta_46111 project.
...
ROOT_URLCONF = 'ai_medical_consulta_46111.urls'
...
WSGI_APPLICATION = 'ai_medical_consulta_46111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_medical_consulta_46111 API",
    "DESCRIPTION": "API documentation for ai_medical_consulta_46111 App",
    "VERSION": "v1",
}
